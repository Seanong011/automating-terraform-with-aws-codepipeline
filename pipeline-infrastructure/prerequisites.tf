...
resource "aws_ssm_parameter" "instance_type" {
  name  = "/demo/ec2/instance-type-seanong"
  type  = "String"
  value = "t2.micro"
...
resource "aws_ssm_parameter" "allowed_cidr" {
  name  = "/demo/security/allowed-cidr-seanong"
  type  = "String"
...
resource "aws_secretsmanager_secret" "api_key" {
  name        = "demo/app/api-key-seanong-1"
...
resource "aws_ssm_parameter" "test_instance_type" {
  name  = "/demo/test/ec2/instance-type-seanong"
  type  = "String"
  value = "t2.micro"
...
resource "aws_ssm_parameter" "prod_instance_type" {
  name  = "/demo/prod/ec2/instance-type-seanong"
  type  = "String"
  value = "t2.small"
  
  tags = {
    Name = "Demo Prod Instance Typ"
  }
}

# Stage 4 environment-specific secrets
resource "aws_secretsmanager_secret" "test_api_key" {
  name        = "demo/test/api-key-seanong"
...
resource "aws_secretsmanager_secret" "prod_api_key" {
  name        = "demo/prod/api-key-seanong"
